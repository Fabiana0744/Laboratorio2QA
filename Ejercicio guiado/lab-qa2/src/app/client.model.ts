...
export class Client {
  ...
  // Método adicional en Client para eliminar una cuenta
    eliminarCuenta(numeroCuenta: number) {
        this.cuentas = this.cuentas.filter(cuenta => cuenta.getNumCuenta() !== numeroCuenta);
    }
